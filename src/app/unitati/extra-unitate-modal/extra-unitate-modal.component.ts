        ...
        this.intrebari.forEach((intrebare, idx) => {
          this.api.getUnitateIntrebariUI(this.unitateId, intrebare.id)
            .subscribe((unitateIntrebare: UnitateIntrebare) => {
              ...
              {
                if(unitateIntrebare.raspuns.indexOf("||") == -1)
                {
                  this.raspunsuri[idx] = unitateIntrebare.raspuns;
                  this.uploaduri[idx] = "";
                }
                else
                {
                  this.raspunsuri[idx] = unitateIntrebare.raspuns.substring(0, unitateIntrebare.raspuns.indexOf("||"));
                  ...
                  this.uploaduri[idx] = unitateIntrebare.raspuns.substring(unitateIntrebare.raspuns.indexOf("||")+2);
                }
  ...
  async editIntrebareU() {
    ...
    for (var i = 0; i < this.raspunsuri.length; i++) {
      ...
      this.adauga = new UnitateIntrebare({
        ...
        raspuns: this.raspunsuri[i] + this.uploaduri[i],
